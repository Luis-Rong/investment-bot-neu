...
State Street Health Care Select Sector SPDR ETF trades under the ticker XLV in the category 'Health'.
Fund size: 40.6 billion USD.

## Costs

The total expense ratio (TER) is 0.09% per year. Costs are deducted from the fund's assets automatically; lower cost means more of the market return stays with the investor.
...
Over the last five years the fund's volatility was moderate - noticeable swings, but far milder than single stocks. In the worst stretch of that period an investor would have seen a temporary loss of 17.1% from peak to trough.
